...
var (
	...
	maccPerms = map[string][]string{
		...
		interdexmoduletypes.ModuleName: {authtypes.Minter, authtypes.Burner, authtypes.Staking},
...
func New(
	...
	scopedInterdexKeeper := app.CapabilityKeeper.ScopeToModule(interdexmoduletypes.ModuleName)
	app.ScopedInterdexKeeper = scopedInterdexKeeper
	app.InterdexKeeper = *interdexmodulekeeper.NewKeeper(
		appCodec,
		keys[interdexmoduletypes.StoreKey],
		keys[interdexmoduletypes.MemStoreKey],
		app.IBCKeeper.ChannelKeeper,
		&app.IBCKeeper.PortKeeper,
		scopedInterdexKeeper,
		app.BankKeeper,
	)
