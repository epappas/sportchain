...
const baseMsgSendBuyOrder: object = { creator: '', port: '', channelID: '', timeoutTimestamp: 0, amountDenom: '', amount: 0, priceDenom: '', price: 0 }
...
export class MsgClientImpl implements Msg {
  ...
  SendCreatePair(request: MsgSendCreatePair): Promise<MsgSendCreatePairResponse> {
    ...
    const promise = this.rpc.request('cosmonaut.interchange.interdex.Msg', 'SendCreatePair', data)
  ...
  SendSellOrder(request: MsgSendSellOrder): Promise<MsgSendSellOrderResponse> {
    ...
    const promise = this.rpc.request('cosmonaut.interchange.interdex.Msg', 'SendSellOrder', data)
    return promise.then((data) => MsgSendSellOrderResponse.decode(new Reader(data)))
  }

  SendBuyOrder(request: MsgSendBuyOrder): Promise<MsgSendBuyOrderResponse> {
    const data = MsgSendBuyOrder.encode(request).finish()
    const promise = this.rpc.request('cosmonaut.interchange.interdex.Msg', 'SendBuyOrder', data)
  ...
  CancelSellOrder(request: MsgCancelSellOrder): Promise<MsgCancelSellOrderResponse> {
    ...
    const promise = this.rpc.request('cosmonaut.interchange.interdex.Msg', 'CancelSellOrder', data)
  ...
  CancelBuyOrder(request: MsgCancelBuyOrder): Promise<MsgCancelBuyOrderResponse> {
    ...
    const promise = this.rpc.request('cosmonaut.interchange.interdex.Msg', 'CancelBuyOrder', data)
