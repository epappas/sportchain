...
export interface InterdexPacketData {
...
const baseInterdexPacketData: object = {}

export const InterdexPacketData = {
  encode(message: InterdexPacketData, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): InterdexPacketData {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseInterdexPacketData } as InterdexPacketData
  ...
  fromJSON(object: any): InterdexPacketData {
    const message = { ...baseInterdexPacketData } as InterdexPacketData
  ...
  toJSON(message: InterdexPacketData): unknown {
    const obj: any = {}
  ...
  fromPartial(object: DeepPartial<InterdexPacketData>): InterdexPacketData {
    const message = { ...baseInterdexPacketData } as InterdexPacketData
    if (object.noData !== undefined && object.noData !== null) {
