...
import { SellOrderBook } from '../interdex/sell_order_book';
import { PageRequest, PageResponse } from '../cosmos/base/query/v1beta1/pagination';
import { BuyOrderBook } from '../interdex/buy_order_book';
import { DenomTrace } from '../interdex/denom_trace';
export const protobufPackage = 'cosmonaut.interchange.interdex';
...
export class QueryClientImpl {
    ...
    SellOrderBook(request) {
        ...
        const promise = this.rpc.request('cosmonaut.interchange.interdex.Query', 'SellOrderBook', data);
    ...
    SellOrderBookAll(request) {
        ...
        const promise = this.rpc.request('cosmonaut.interchange.interdex.Query', 'SellOrderBookAll', data);
    ...
    BuyOrderBook(request) {
        ...
        const promise = this.rpc.request('cosmonaut.interchange.interdex.Query', 'BuyOrderBook', data);
    ...
    BuyOrderBookAll(request) {
        ...
        const promise = this.rpc.request('cosmonaut.interchange.interdex.Query', 'BuyOrderBookAll', data);
    ...
    DenomTrace(request) {
        ...
        const promise = this.rpc.request('cosmonaut.interchange.interdex.Query', 'DenomTrace', data);
    ...
    DenomTraceAll(request) {
        ...
        const promise = this.rpc.request('cosmonaut.interchange.interdex.Query', 'DenomTraceAll', data);
