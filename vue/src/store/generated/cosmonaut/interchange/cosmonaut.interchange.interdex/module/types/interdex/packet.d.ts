...
export declare const protobufPackage = "cosmonaut.interchange.interdex";
...
export declare const InterdexPacketData: {
    encode(message: InterdexPacketData, writer?: Writer): Writer;
