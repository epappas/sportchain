...
export declare type ConsumingMsgGoldPriceDataResponse = object;
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     * @request GET:/interchange/consuming/gold_price_result/{requestId}
     */
    queryGoldPriceResult: (requestId: string, params?: RequestParams) => Promise<HttpResponse<ConsumingQueryGoldPriceResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     * @request GET:/interchange/consuming/last_gold_price_id
     */
    queryLastGoldPriceId: (params?: RequestParams) => Promise<HttpResponse<ConsumingQueryLastGoldPriceIdResponse, RpcStatus>>;
}
export {};
