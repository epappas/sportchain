...
import { Post } from '../sportchain/post'

export const protobufPackage = 'epappas.sportchain.sportchain'
...
export class QueryClientImpl implements Query {
  ...
  Posts(request: QueryPostsRequest): Promise<QueryPostsResponse> {
    ...
    const promise = this.rpc.request('epappas.sportchain.sportchain.Query', 'Posts', data)
