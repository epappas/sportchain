...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/epappas/sportchain/scavenge/commit
         */
        this.queryCommitAll = (query, params = {}) => this.request({
            path: `/epappas/sportchain/scavenge/commit`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/epappas/sportchain/scavenge/commit/{index}
         */
        this.queryCommit = (index, params = {}) => this.request({
            path: `/epappas/sportchain/scavenge/commit/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/epappas/sportchain/scavenge/scavenge
         */
        this.queryScavengeAll = (query, params = {}) => this.request({
            path: `/epappas/sportchain/scavenge/scavenge`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/epappas/sportchain/scavenge/scavenge/{index}
         */
        this.queryScavenge = (index, params = {}) => this.request({
            path: `/epappas/sportchain/scavenge/scavenge/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
