...
export class MsgClientImpl implements Msg {
  ...
  SubmitScavenge(request: MsgSubmitScavenge): Promise<MsgSubmitScavengeResponse> {
    ...
    const promise = this.rpc.request('epappas.sportchain.scavenge.Msg', 'SubmitScavenge', data)
  ...
  CommitSolution(request: MsgCommitSolution): Promise<MsgCommitSolutionResponse> {
    ...
    const promise = this.rpc.request('epappas.sportchain.scavenge.Msg', 'CommitSolution', data)
  ...
  RevealSolution(request: MsgRevealSolution): Promise<MsgRevealSolutionResponse> {
    ...
    const promise = this.rpc.request('epappas.sportchain.scavenge.Msg', 'RevealSolution', data)
