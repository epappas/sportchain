...
export const protobufPackage = 'epappas.sportchain.scavenge'
...
export class QueryClientImpl implements Query {
  ...
  Scavenge(request: QueryGetScavengeRequest): Promise<QueryGetScavengeResponse> {
    ...
    const promise = this.rpc.request('epappas.sportchain.scavenge.Query', 'Scavenge', data)
  ...
  ScavengeAll(request: QueryAllScavengeRequest): Promise<QueryAllScavengeResponse> {
    ...
    const promise = this.rpc.request('epappas.sportchain.scavenge.Query', 'ScavengeAll', data)
  ...
  Commit(request: QueryGetCommitRequest): Promise<QueryGetCommitResponse> {
    ...
    const promise = this.rpc.request('epappas.sportchain.scavenge.Query', 'Commit', data)
  ...
  CommitAll(request: QueryAllCommitRequest): Promise<QueryAllCommitResponse> {
    ...
    const promise = this.rpc.request('epappas.sportchain.scavenge.Query', 'CommitAll', data)
