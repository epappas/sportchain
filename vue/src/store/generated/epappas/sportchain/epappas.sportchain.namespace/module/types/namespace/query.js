...
import { Whois } from '../namespace/whois';
...
export class QueryClientImpl {
    ...
    Whois(request) {
        ...
        const promise = this.rpc.request('epappas.sportchain.namespace.Query', 'Whois', data);
    ...
    WhoisAll(request) {
        ...
        const promise = this.rpc.request('epappas.sportchain.namespace.Query', 'WhoisAll', data);
