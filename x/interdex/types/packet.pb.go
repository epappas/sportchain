...
type InterdexPacketData struct {
	// Types that are valid to be assigned to Packet:
	//	*InterdexPacketData_NoData
	//	*InterdexPacketData_BuyOrderPacket
	//	*InterdexPacketData_SellOrderPacket
	//	*InterdexPacketData_CreatePairPacket
	Packet isInterdexPacketData_Packet `protobuf_oneof:"packet"`
}

func (m *InterdexPacketData) Reset()         { *m = InterdexPacketData{} }
func (m *InterdexPacketData) String() string { return proto.CompactTextString(m) }
func (*InterdexPacketData) ProtoMessage()    {}
func (*InterdexPacketData) Descriptor() ([]byte, []int) {
	return fileDescriptor_c567bb915f1d7fa9, []int{0}
}
func (m *InterdexPacketData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *InterdexPacketData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_InterdexPacketData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *InterdexPacketData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_InterdexPacketData.Merge(m, src)
}
func (m *InterdexPacketData) XXX_Size() int {
	return m.Size()
}
func (m *InterdexPacketData) XXX_DiscardUnknown() {
	xxx_messageInfo_InterdexPacketData.DiscardUnknown(m)
}

var xxx_messageInfo_InterdexPacketData proto.InternalMessageInfo

type isInterdexPacketData_Packet interface {
	isInterdexPacketData_Packet()
	MarshalTo([]byte) (int, error)
	Size() int
}

type InterdexPacketData_NoData struct {
	NoData *NoData `protobuf:"bytes,1,opt,name=noData,proto3,oneof" json:"noData,omitempty"`
}
type InterdexPacketData_BuyOrderPacket struct {
	BuyOrderPacket *BuyOrderPacketData `protobuf:"bytes,4,opt,name=buyOrderPacket,proto3,oneof" json:"buyOrderPacket,omitempty"`
}
type InterdexPacketData_SellOrderPacket struct {
...
type InterdexPacketData_CreatePairPacket struct {
...
func (*InterdexPacketData_NoData) isInterdexPacketData_Packet()           {}
func (*InterdexPacketData_BuyOrderPacket) isInterdexPacketData_Packet()   {}
func (*InterdexPacketData_SellOrderPacket) isInterdexPacketData_Packet()  {}
func (*InterdexPacketData_CreatePairPacket) isInterdexPacketData_Packet() {}

func (m *InterdexPacketData) GetPacket() isInterdexPacketData_Packet {
	if m != nil {
		return m.Packet
	}
	return nil
...
func (m *InterdexPacketData) GetNoData() *NoData {
	if x, ok := m.GetPacket().(*InterdexPacketData_NoData); ok {
		return x.NoData
	}
	return nil
}

func (m *InterdexPacketData) GetBuyOrderPacket() *BuyOrderPacketData {
	if x, ok := m.GetPacket().(*InterdexPacketData_BuyOrderPacket); ok {
		return x.BuyOrderPacket
	}
	return nil
}

func (m *InterdexPacketData) GetSellOrderPacket() *SellOrderPacketData {
	if x, ok := m.GetPacket().(*InterdexPacketData_SellOrderPacket); ok {
		return x.SellOrderPacket
	}
	return nil
}

func (m *InterdexPacketData) GetCreatePairPacket() *CreatePairPacketData {
	if x, ok := m.GetPacket().(*InterdexPacketData_CreatePairPacket); ok {
...
func (*InterdexPacketData) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*InterdexPacketData_NoData)(nil),
		(*InterdexPacketData_BuyOrderPacket)(nil),
		(*InterdexPacketData_SellOrderPacket)(nil),
		(*InterdexPacketData_CreatePairPacket)(nil),
	}
}
...
func (*NoData) Descriptor() ([]byte, []int) {
	return fileDescriptor_c567bb915f1d7fa9, []int{1}
}
...
func (*CreatePairPacketData) Descriptor() ([]byte, []int) {
	return fileDescriptor_c567bb915f1d7fa9, []int{2}
}
...
func (*CreatePairPacketAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_c567bb915f1d7fa9, []int{3}
}
...
func (*SellOrderPacketData) Descriptor() ([]byte, []int) {
	return fileDescriptor_c567bb915f1d7fa9, []int{4}
}
...
func (*SellOrderPacketAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_c567bb915f1d7fa9, []int{5}
}
...
func (*BuyOrderPacketData) Descriptor() ([]byte, []int) {
	return fileDescriptor_c567bb915f1d7fa9, []int{6}
}
...
func (*BuyOrderPacketAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_c567bb915f1d7fa9, []int{7}
}
...
func init() {
	proto.RegisterType((*InterdexPacketData)(nil), "cosmonaut.interchange.interdex.InterdexPacketData")
	proto.RegisterType((*NoData)(nil), "cosmonaut.interchange.interdex.NoData")
	proto.RegisterType((*CreatePairPacketData)(nil), "cosmonaut.interchange.interdex.CreatePairPacketData")
	proto.RegisterType((*CreatePairPacketAck)(nil), "cosmonaut.interchange.interdex.CreatePairPacketAck")
	proto.RegisterType((*SellOrderPacketData)(nil), "cosmonaut.interchange.interdex.SellOrderPacketData")
	proto.RegisterType((*SellOrderPacketAck)(nil), "cosmonaut.interchange.interdex.SellOrderPacketAck")
	proto.RegisterType((*BuyOrderPacketData)(nil), "cosmonaut.interchange.interdex.BuyOrderPacketData")
	proto.RegisterType((*BuyOrderPacketAck)(nil), "cosmonaut.interchange.interdex.BuyOrderPacketAck")
}

func init() { proto.RegisterFile("interdex/packet.proto", fileDescriptor_c567bb915f1d7fa9) }

var fileDescriptor_c567bb915f1d7fa9 = []byte{
	...
	,
}

func (m *InterdexPacketData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *InterdexPacketData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *InterdexPacketData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *InterdexPacketData_NoData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *InterdexPacketData_NoData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NoData != nil {
		{
...
func (m *InterdexPacketData_CreatePairPacket) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *InterdexPacketData_CreatePairPacket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *InterdexPacketData_SellOrderPacket) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *InterdexPacketData_SellOrderPacket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *InterdexPacketData_BuyOrderPacket) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *InterdexPacketData_BuyOrderPacket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *InterdexPacketData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InterdexPacketData_NoData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InterdexPacketData_CreatePairPacket) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InterdexPacketData_SellOrderPacket) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InterdexPacketData_BuyOrderPacket) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InterdexPacketData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: InterdexPacketData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: InterdexPacketData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Packet = &InterdexPacketData_NoData{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Packet = &InterdexPacketData_CreatePairPacket{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Packet = &InterdexPacketData_SellOrderPacket{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			m.Packet = &InterdexPacketData_BuyOrderPacket{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
